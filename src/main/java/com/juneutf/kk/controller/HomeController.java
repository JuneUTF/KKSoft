package com.juneutf.kk.controller;
...
import com.juneutf.kk.config.vender.CreateToken;
...
public class HomeController {
	 ...
	 * @param setPasswordModel パスワード設定モデルオブジェクト
	 * @param model  モデルオブジェクト
	 * @return "redirect:/kk/mtg/job" - パスワード設定後のリダイレクト
	 */
