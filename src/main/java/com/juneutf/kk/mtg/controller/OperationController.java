...
import com.juneutf.kk.config.vender.CoverRegister;
import com.juneutf.kk.config.vender.EmailService;
import com.juneutf.kk.model.APIMessengerModel;
import com.juneutf.kk.mtg.model.OperationModel;
import com.juneutf.kk.mtg.model.TableModel;
import com.juneutf.kk.mtg.service.OperationService;

import lombok.extern.slf4j.Slf4j;

@Slf4j
@Controller
@RequestMapping("/mtg/ad")
public class OperationController {
	...
	public String postOperationDelete(TableModel tableModel) {
		try {
			...
			return "redirect:/mtg/ad/operation";
		} catch (Exception e) {
